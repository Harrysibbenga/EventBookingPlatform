...
<template>
  <div class="max-w-2xl mx-auto">
    ...
    <!-- Settings Display for Cookies Page -->
    ...
    <div class="flex flex-col sm:flex-row gap-3 mb-6">
      ...
      <button
        ...
        class="flex-1 bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-all duration-200 flex items-center justify-center"
      >
...
const saveConsentPreferences = () => {
  ...
  // Dispatch custom event to notify universal system
...
const loadAnalytics = () => {
  if (analyticsEnabled.value && props.gaMeasurementId && props.gaMeasurementId !== 'GA_MEASUREMENT_ID') {
