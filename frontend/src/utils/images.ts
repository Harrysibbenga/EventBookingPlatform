...
export const IMAGES: Record<string, ImageMeta> = {
  ...
  thirteenGoldBlack: {
    title: '13 — Rose Gold & Black',
    category: 'Birthdays',
    src: (ThirteenGoldBlack as any)?.src ?? (ThirteenGoldBlack as string),
    alt: 'Number 13 display in rose gold and black styling',
  },
  twentySixWhiteYellow: {
    title: '26 — Ballons and Flowers',
    category: 'Birthdays',
    src: (TwentySixWhiteYellow as any)?.src ?? (TwentySixWhiteYellow as string),
    alt: 'Number 26 display in ballons and flowers',
  },
  sixtyNavy: {
    title: '60 — Black & Gold',
    category: 'Birthdays',
    src: (SixtyNavy as any)?.src ?? (SixtyNavy as string),
    alt: 'Number 60 display with black and gold balloons',
  },
  seventyRedMetallic: {
    title: '70 — Metallic',
    category: 'Birthdays',
